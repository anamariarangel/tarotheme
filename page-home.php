        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                   <?
                     $hero_title = get_theme_mod( 'set_hero_title', __( 'Please, type some title', 'tarotheme' ) );
                     $hero_subtitle = get_theme_mod( 'set_hero_subtitle', __( 'Please, type some subtitle', 'tarotheme' ) );
                     $hero_button_link = get_theme_mod( 'set_hero_button_link', '#' );
                     $hero_button_text = get_theme_mod( 'set_hero_button_text', __( 'Learn More', 'tarotheme' ) );              
                    ...
                    <h2><?php esc_html_e( 'Services', 'tarotheme' ) ?></h2>
                        <div class="container">
                        ...
                        <h2><?php esc_html_e( 'Latest News', 'tarotheme' ) ?></h2>
